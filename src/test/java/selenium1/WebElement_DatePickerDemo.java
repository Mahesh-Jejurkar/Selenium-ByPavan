...
public class WebElement_DatePickerDemo {
	...
	public static void main(String[] args) throws Exception {
		...
		while (true) {
			Thread.sleep(2000);
			String actual_month = driver.findElement(By.xpath("//*[@id='ui-datepicker-div']/div/div/span[1]"))
					.getText();
		...
		Thread.sleep(2000);
		driver.findElement(
				By.xpath("//*[@id='ui-datepicker-div']/table/tbody/tr/td/a[contains(text()," + expected_day + ")]"))
				.click();
