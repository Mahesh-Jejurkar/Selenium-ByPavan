...
public class TestNGTestSeven {
	...
	String element_username = "//*[@name='uid']", element_password = "//*[@name='password']",
			element_signin = "//*[@name='btnLogin']", element_logout = "//*[text()='Log out']";
	...
	public void openBrowser() throws Exception {
		System.setProperty("webdriver.gecko.driver",
				System.getProperty("user.dir") + "//browser-driver//geckodriver.exe");
